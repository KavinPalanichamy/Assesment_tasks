...
-> To acheive a good efficiency the iterationas has been set to 10000 and the step to 0.1, and hence the model may take 5-10 seconds to train.

-> A distribution map was generated using MATLAB to verify the outcome in an intuitive wave by identifying the clusters.
